...
configuração aplicada corresponde à configuração desejada.
...
O script altera o hostname do switch para `SWITCH_AUTOMATIZADO_R1`
(valor predefinido em `config.py`).
